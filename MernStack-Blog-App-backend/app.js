  ...
  import * as blogController from "./controllers/blog-controller"; // Import all exports from blog-controller.js
  ...
  // Apply multer middleware to the route for adding a new blog
  app.post("/api/blog/add", upload.single("file"), blogController.addBlog);

  mongoose.set('strictQuery', false);

  mongoose
    .connect("mongodb+srv://Samiha:Samiha28@cluster0.73tscl4.mongodb.net/BLOG_VOYAGE")
    .then(() => {
      app.listen(5000, () => {
